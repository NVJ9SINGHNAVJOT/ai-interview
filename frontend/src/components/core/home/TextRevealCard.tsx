      ...
      <div className="h-40  relative flex items-center overflow-hidden">
        ...
        >
          <p
            ...
            className=" text-[2.7rem] py-10 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className=" text-[2.7rem] py-10 font-bold bg-clip-text text-slate-500 bg-[#323238]">{text}</p>
          <MemoizedStars />
        </div>
      </div>
    </div>
